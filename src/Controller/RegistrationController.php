...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordHasherInterface $userPasswordHasher, EntityManagerInterface $entityManager): Response
    {
        ...
        if($userTest){
            $this->addFlash('error', 'Du bist bereits registriert!');
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->emailVerifier->sendEmailConfirmation('app_verify_email', $user,
                (new TemplatedEmail())
                    ->from(new Address('my.dnd.spellbook@gmail.com', 'WWW Mail Bot'))
                    ->to($user->getEmail())
            ...
            */
            $this->addFlash('success', 'Registrierung erfolgreich! Du kannst dich jetzt in deinen Account einloggen!');
            return $this->redirectToRoute('home');
        }
    ...
    public function verifyUserEmail(Request $request, TranslatorInterface $translator, UserRepository $userRepository): Response
    {
        ...
        $this->addFlash('success', 'Deine Email wurde verifiziert!');
